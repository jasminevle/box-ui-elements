export default {
  ...
  "be.contentSidebar.activityFeed.task.taskAnyAffordanceTooltip": "このタスクの作成者は、タスクを完了するために1人の担当者のみを必要としています",
  ...
  "be.contentSidebar.activityFeed.taskForm.taskAnyCheckboxLabel": "このタスクを完了するために必要な担当者は1人だけです",
  "be.contentSidebar.activityFeed.taskForm.taskAnyInfoTooltip": "デフォルトでは、すべての担当者がタスクを完了する前にアクションを実行する必要があります。このオプションを選択すると、このタスクを完了するために必要となる担当者は1人だけなります。",
  ...
  "be.contentSidebar.activityFeed.taskNew.taskShowLessAssignees": "表示を減らす",
  ...
  "be.contentSidebar.activityFeed.taskNew.tasksFeedStatusLabel": "ステータス: {taskStatus}",
  ...
  "be.contentSidebar.addTask.approval.description": "作業を進めるための承認を要求します",
  "be.contentSidebar.addTask.approval.title": "承認タスクの作成",
  "be.contentSidebar.addTask.general": "一般タスク",
  "be.contentSidebar.addTask.general.description": "完了する必要のある作業を追跡します",
  ...
  "boxui.classification.addClassification": "分類",
  ...
  "boxui.share.sharedLinkSettings.sharedLinkSettingWarningLinkText": "共有リンク設定の詳細について確認する。",
  ...
  "boxui.unifiedShare.contactsExceedLimitError": "一度に追加できるコラボレータは最大{maxContacts}人までです。招待をバッチに分割して、もう一度やり直してください。",
  ...
  "boxui.unifiedShare.linkShareOff": "共有リンクを有効にする",
  "boxui.unifiedShare.linkShareOn": "共有リンクを有効にしました",
